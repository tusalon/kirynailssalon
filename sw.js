...
const urlsToCache = [
  ...
  '/kirynailssalon/utils/push-config.js',
  '/kirynailssalon/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/kirynailssalon/icons/icon-192x192.png',
    badge: '/kirynailssalon/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/kirynailssalon/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/kirynailssalon/admin.html';
  event.waitUntil(
